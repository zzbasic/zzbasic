...
12. [Modules](#modules)
13. [Text Type](#text-type)
14. [Scopes and Local Variables](#scopes-and-local-variables)
15. [Resource Summary](#resource-summary)
...
- Automatic deallocation when exiting scope
- Allocation tracking with Object Tracker
...
- Local scope within blocks (IF, WHILE, FOR)
...
**Characteristics:**
- Arrays are dynamic
- In v0.8.0 support numbers and strings
- Index starts at 0
...
### NEW v0.8.0: Custom Function Support

**Description:** Allows users to define their own functions.
...
- Parameters: Zero or more, separated by commas
- Body: One or more statements
- `return`: Returns a value (optional)
- `end function`: Required
- Supports recursion
- Local scope for parameters and internal variables
...
**Description:** Functions create local scope for parameters and variables.
...
1. **Typing:** Functions can return any type
2. **Recursion:** Supported (limit depends on stack)
3. **Nested Calls:** Functions can call other functions
4. **Scope:** Parameters and local variables are isolated
5. **Global Access:** Functions can access global variables
...
NOTE: In v0.8.0 only displays message
...
**4. Automatic Memory Deallocation**

When TEXT exits scope, memory is automatically freed. This was implemented with the local scopes system.
...
**Description:** Variables created within blocks (IF, WHILE, FOR, FUNCTION) now have local scope.
...
| Modulo Operator (%) | ✅ Complete | 0.8.0 |
...
| DO...END | ✅ Complete | 0.8.0 |
| Comparison Operators | ✅ Complete | 0.2.0 |
| String Comparison | ✅ Complete | 0.8.0 |
| Logical Operators | ✅ Complete | 0.3.0 |
| Typed Arrays | ✅ Complete | 0.8.0 |
| Built-in Functions | ✅ Complete | 0.5.0 |
| String Functions | ✅ Complete | 0.8.0 |
| **User-Defined Functions** | **✅ New** | **0.8.0** |
| Module Import | ✅ Started | 0.5.0 |
| Load/Save | ✅ Complete | 0.6.0 |
| Text Type | ✅ Complete | 0.7.0 |
| Local Scopes | ✅ Complete | 0.7.0 |
| Object Tracker | ✅ Complete | 0.7.0 |
| Automatic Deallocation | ✅ Complete | 0.7.0 |
...
1. **User-Defined Functions**
   - Create functions with `function name(params) ... end function`
   - `return` command to return values
   - Support for parameters (0 or more)
   - Local scope for parameters and internal variables
   - Function call as expression (`let x = sum(3, 5)`)
   - Functions calling other functions
   - Recursion support

2. **Modulo Operator (%)**
   - Operator for calculating division remainder
...
4. **String Functions**
   ...
   - `split()`, `join()` for advanced manipulation

5. **Typed Arrays**
   - Arrays support numbers and strings
   - `array()` with automatic typing

6. **DO...END**
   - `do...end` for isolated scope
   - `do...end while` for loop with end check
