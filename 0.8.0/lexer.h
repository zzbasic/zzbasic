...
typedef enum {
    ...
    TOKEN_STRING,       // literal string entre "  (até 128 char, alocação na pilha)
    TOKEN_TEXT,         // literal Texto entre """ (mais que 128 char, alocação na heap) 
...
typedef struct
{
    ...
    char* text_content;             // TOKEN_TEXT (heap)
