...
// Forward declaration of ASTNode (opaque)
...
// Estrutura opaca para função definida pelo usuário
...
int symbol_table_set_function(SymbolTable* table, const char* name, UserFunction* function);
int symbol_table_get_function(SymbolTable* table, const char* name, UserFunction** out_function);
int symbol_table_has_function(SymbolTable* table, const char* name);

// Acessores para UserFunction (sem expor a struct)
