...
13. [Escopos e Variáveis Locais](#escopos-e-variáveis-locais)
14. [Resumo dos recursos](#resumo-dos-recursos)
...
- **NOVO v0.7.0:** Liberação automática ao sair do escopo
- **NOVO v0.7.0:** Rastreamento de alocações com Object Tracker
...
- **NOVO v0.7.0:** Escopo local dentro de blocos (IF, WHILE, FOR)
...
- **NOVO v0.7.0:** Suporta escopos locais
...
- Na v0.7.0 só podem conter números
- Índice começa em 0
...
OBSERVAÇÃO: Na v0.7.0 apenas exibe mensagem
...
**4. Liberação Automática de Memória (NOVO v0.7.0)**

**IMPORTANTE:** Na v0.7.0, a liberação de memória é **AUTOMÁTICA**. Quando um TEXT sai do escopo, a memória é liberada automaticamente. Isso foi implementado com o sistema de escopos locais.

**5. Rastreamento de Alocações (NOVO v0.7.0)**
...
### NOVO v0.7.0: Suporte a Escopos Locais

**Descrição:** Variáveis criadas dentro de blocos (IF, WHILE, FOR) agora têm escopo local.
...
| **Escopos Locais** | **✅ Novo** | **0.7.0** |
| **Object Tracker** | **✅ Novo** | **0.7.0** |
| **Liberação Automática** | **✅ Novo** | **0.7.0** |
...
1. **Escopos Locais**
   - Variáveis criadas em blocos (IF, WHILE, FOR) agora têm escopo local
   - Liberação automática ao sair do bloco
   - Suporte a escopos aninhados

2. **Liberação Automática de Text**
   - Text agora é liberado automaticamente ao sair do escopo
   - Sem vazamento de memória
   - Seguro para usar em loops

3. **Object Tracker Module**
   - Módulo genérico para rastreamento de alocações
   - Visualizar quais objetos estão alocados
   - Detectar memory leaks
   - Reutilizável para novos tipos de dados
   - Disponível apenas para o desenvolvimento do ZzBasic

4. **Melhorias de Estabilidade**
   - Correção de bug crítico em `execute_stmt_list_with_ctx()`
