...
static Token lexer_read_identifier(Lexer* lexer)
{
    ...
    else if (strcmp(buffer, "nl") == 0)
    {
        token.type = TOKEN_NL;
        strcpy(token.text, "nl");
    }
    ...
    //========== ALINHAMENTO NO PRINT ============
    else if (strcmp(buffer, "width") == 0)
    {
        token.type = TOKEN_WIDTH;
        strcpy(token.text, "width");
    }
    else if (strcmp(buffer, "left") == 0)
    {
        token.type = TOKEN_LEFT;
        strcpy(token.text, "left");
    }
    else if (strcmp(buffer, "right") == 0)
    {
        token.type = TOKEN_RIGHT;
        strcpy(token.text, "right");
    }
    else if (strcmp(buffer, "center") == 0)
    {
        token.type = TOKEN_CENTER;
        strcpy(token.text, "center");
    }
    else if (strcmp(buffer, "nocolor") == 0)
    {
        token.type = TOKEN_NOCOLOR;
        strcpy(token.text, "nocolor");
    }
    //============= CORES NO PRINT =================
    else if (strcmp(buffer, "black") == 0)
    {
        token.type = TOKEN_BLACK;
        strcpy(token.text, "black");
    }
    else if (strcmp(buffer, "red") == 0)
    {
        token.type = TOKEN_RED;
        strcpy(token.text, "red");
    }
    else if (strcmp(buffer, "green") == 0)
    {
        token.type = TOKEN_GREEN;
        strcpy(token.text, "green");
    }
    else if (strcmp(buffer, "yellow") == 0)
    {
        token.type = TOKEN_YELLOW;
        strcpy(token.text, "yellow");
    }
    else if (strcmp(buffer, "blue") == 0)
    {
        token.type = TOKEN_BLUE;
        strcpy(token.text, "blue");
    }
    else if (strcmp(buffer, "magenta") == 0)
    {
        token.type = TOKEN_MAGENTA;
        strcpy(token.text, "magenta");
    }
    else if (strcmp(buffer, "cyan") == 0)
    {
        token.type = TOKEN_CYAN;
        strcpy(token.text, "cyan");
    }
    else if (strcmp(buffer, "white") == 0)
    {
        token.type = TOKEN_WHITE;
        strcpy(token.text, "white");
    }
    else if (strcmp(buffer, "bred") == 0)
    {
        token.type = TOKEN_BRED;
        strcpy(token.text, "bred");
    }
    else if (strcmp(buffer, "bgreen") == 0)
    {
        token.type = TOKEN_BGREEN;
        strcpy(token.text, "bgreen");
    }
    else if (strcmp(buffer, "byellow") == 0)
    {
        token.type = TOKEN_BYELLOW;
        strcpy(token.text, "byellow");
    }
    else if (strcmp(buffer, "bblue") == 0)
    {
        token.type = TOKEN_BBLUE;
        strcpy(token.text, "bblue");
    }
    else if (strcmp(buffer, "bmagenta") == 0)
    {
        token.type = TOKEN_BMAGENTA;
        strcpy(token.text, "bmagenta");
    }
    else if (strcmp(buffer, "bcyan") == 0)
    {
        token.type = TOKEN_BCYAN;
        strcpy(token.text, "bcyan");
    }
    else if (strcmp(buffer, "bwhite") == 0)
    {
        token.type = TOKEN_BWHITE;
        strcpy(token.text, "bwhite");
    }
    else if (strcmp(buffer, "bgblack") == 0)
    {
        token.type = TOKEN_BGBLACK;
        strcpy(token.text, "bgblack");
    }
    else if (strcmp(buffer, "bgred") == 0)
    {
        token.type = TOKEN_BGRED;
        strcpy(token.text, "bgred");
    }
    else if (strcmp(buffer, "bggreen") == 0)
    {
        token.type = TOKEN_BGGREEN;
        strcpy(token.text, "bggreen");
    }
    else if (strcmp(buffer, "bgyellow") == 0)
    {
        token.type = TOKEN_BGYELLOW;
        strcpy(token.text, "bgyellow");
    }
    else if (strcmp(buffer, "bgblue") == 0)
    {
        token.type = TOKEN_BGBLUE;
        strcpy(token.text, "bgblue");
    }
    else if (strcmp(buffer, "bgmagenta") == 0)
    {
        token.type = TOKEN_BGMAGENTA;
        strcpy(token.text, "bgmagenta");
    }
    else if (strcmp(buffer, "bgcyan") == 0)
    {
        token.type = TOKEN_BGCYAN;
        strcpy(token.text, "bgcyan");
    }
    else if (strcmp(buffer, "bgwhite") == 0)
    {
        token.type = TOKEN_BGWHITE;
        strcpy(token.text, "bgwhite");
    }
