...
static const char* keywords_list[] = 
{
    ...
    "bgcyan",
    "bgwhite",
    NULL  // Marcador de fim (opcional, mas útil para loops)
};
...
int main()
{
    ...
    const char code[] = "let nl print width left right center"
    " nocolor black red green yellow blue magenta cyan white"
    " bred bgreen byellow bblue bmagenta bcyan bwhite bgblack"
    " bgred bggreen bgyellow bgblue bgmagenta bgcyan bgwhite";
    
    printf("%sZzBasic Lexer Test v0.4.2 - reconhecimento de palavras-chave%s\n\n", COLOR_HEADER, COLOR_RESET);    
    printf("%sPalavras-chave:%s%s\n\n", COLOR_HEADER, code, COLOR_RESET);
